/*
  ...
  MINI SISTEMA DE AUTOMAÇÃO RESIDENCIAL
  NOME: RODRIGO DO AMARAL ALVES
*/
...
void loop()
{
  ...
  //Funcionamento Sensor infravermelho
  ...
  if(temperatura>=29){
   ...
   //Funcionamento Sensor iluminacao ambientes externos
